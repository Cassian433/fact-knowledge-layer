...
async def main() -> None:
    ...
    async with async_playwright() as p:
        ...
        await tab(pg, "documents"); await pg.wait_for_timeout(1500)
        await pg.screenshot(path=OUT / "documents.png")

        await tab(pg, "facts"); await pg.wait_for_timeout(800)
        ...
        await tab(pg, "showcase"); await pg.wait_for_timeout(3000)
        ...
        await tab(pg, "relations"); await pg.wait_for_timeout(800)
        ...
        await tab(pg, "stats"); await pg.wait_for_timeout(1200)
